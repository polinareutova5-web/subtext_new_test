...
Если действие `ai_chat` еще не добавлено или сервис ИИ временно недоступен, фронтенд покажет понятное сообщение и предложит отправить вопрос преподавателю через вкладку «Поддержка».
