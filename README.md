...
Если действие `ai_chat` еще не добавлено или сервис ИИ временно недоступен, фронтенд не показывает техническую ошибку ученику: он включает локальный помощник для вопросов по расписанию, ближайшему уроку, ДЗ и прогрессу, а для учебных объяснений предлагает написать преподавателю через вкладку «Поддержка».
