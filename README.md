...
- `lessons_remaining` — вручную заполняемое количество оплаченных/оставшихся уроков; сайт показывает это число в профиле ученика. Можно назвать колонку по-русски `осталось уроков` или `оплаченные уроки`, Apps Script тоже ее найдет.
